package in.cdac.ageservice.ageservice.logic;
...
public class AgeCalculator {
	 ...
	 * sdf.parse("29/11/1981"); //Yeh !! It's my date of birth :-) Age age =
	 * calculateAge(birthDate); //My age is System.out.println(age); }
	 */
